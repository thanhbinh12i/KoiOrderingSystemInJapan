        ...
        <html>
            ...
            <body>
                <div class="cancellation-email">
                    ...
                    <p>Chúng tôi xác nhận đã nhận được yêu cầu hủy đơn đặt chỗ của Quý khách với mã đơn <span class="order-id">${item.quotationId}</span></p>
                    ...
                    <div class="order-details">
                        ...
                        <div class="details-row">
                            ...
                            <span class="currency">${formatCurrency(item.priceOffer)}</span>
                        </div>
                        <div class="details-row">
                    ...
                    <p>Theo chính sách của chúng tôi, yêu cầu hủy đơn của Quý khách đã được chấp nhận. Quý khách sẽ được hoàn lại 50% số tiền đã thanh toán, tương đương <span class="currency refund">${formatCurrency(refundAmount)}</span>.</p>
